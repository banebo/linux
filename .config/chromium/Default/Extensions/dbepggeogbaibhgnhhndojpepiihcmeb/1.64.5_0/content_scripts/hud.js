  ...
  HUD = {
    ...
    copyToClipboard: function(text) {
      return DomUtils.documentComplete((function(_this) {
        return function() {
          var ref;
          _this.init();
          return (ref = _this.hudUI) != null ? ref.postMessage({
    ...
    pasteFromClipboard: function(pasteListener) {
      ...
      return DomUtils.documentComplete((function(_this) {
        return function() {
          _this.init();
          _this.hudUI.toggleIframeElementClasses("vimiumUIComponentHidden", "vimiumUIComponentVisible");
    ...
    unfocusIfFocused: function() {
      var ref;
      if (document.activeElement === ((ref = this.hudUI) != null ? ref.iframeElement : void 0)) {
